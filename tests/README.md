...
Test files:
- [01_color_bars.asm](01_color_bars.asm) - displays 15 vertical color bars with black screen border (useful for video output debugging).
- [02_color_bars2.asm](02_color_bars2.asm) - variation of the pervious test - the bars switch brightness in the middle. 
