...
| [boot.v3_unifdc.bin](boot.v3_unifdc.bin) | `2ac7cfb3e7f1522607a250099d1ef31d` | `2764` - 8kB EPROM    | `U26`      | `G4/5`           | Bootstrap code - alternative version (see below) |
...
* [boot.v3_unifdc.bin](boot.v3_unifdc.bin) is based on [boot.v3.bin](boot.v3.bin), but patched (by me) to properly support `WD37C65`-based floppy controller.
